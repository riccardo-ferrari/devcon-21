...
@Component(
	immediate = true,
	property = "scheduled.task.executor.type=" + ItemsExportScheduledTaskExecutorImpl.KEY,
	service = ScheduledTaskExecutor.class
)
public class ItemsExportScheduledTaskExecutorImpl
	extends BaseExportScheduledTaskExecutor {

	public static final String KEY = "aws-personalize-items-export";
	...
	protected String getBatchEngineTaskItemDelegateName() {
		return "items-aws-personalize";
	}

	@Override
	protected String getExportClassName() {
		return Items.class.getName();
	}

	@Override
	protected List<String> getExportFiledList() {
		return Arrays.asList("ITEM_ID", "CATEGORY");
	}
